...
function aimee_engine_admin_page() {
    ...
    <div class="wrap">
        ...
        <table class="widefat striped">
            <thead><tr><th>When (UTC)</th><th>User</th><th>Route</th><th>Classifier</th><th>Model</th><th>Refusal</th><th>Photo</th><th>Stage</th><th>Total ms</th></tr></thead>
            <tbody>
            <?php foreach ($recent as $turn): ?>
                <tr>
                    ...
                    <td><?php echo intval($turn['total_ms'] ?? 0); ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>

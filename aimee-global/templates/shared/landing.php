...
$privacy_review_url = $privacy_url . '#ai-human-review';
$privacy_safeguarding_url = $privacy_url . '#safeguarding';
$privacy_rights_url = $privacy_url . '#rights-complaints';
...
$mobile_copy = $c['mobile_available'] ? ($aimee_market === 'us' ? 'optional SMS through Aimee’s UK +44 number' : 'optional UK mobile messaging') : 'private web chat and voice notes, with mobile messaging where available';
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="Hi, I'm Aimee. A next-generation digital companion with Synthetic Neuroanatomy for memory, mood, perception, boundaries and continuity, plus private voice notes and <?php echo esc_attr($mobile_copy); ?>.">
    ...
    echo wp_json_encode([
        ...
        'description'         => 'A next-generation digital companion powered by Engram Intelligence, combining persistent relationship state, layered memory, behavioural observation, visual awareness, private voice notes and ' . $mobile_copy . '.',
        'url'                 => $home_url,
        'publisher'           => [
            '@type' => 'Organization',
        ...
        'offers'              => [
            ...
            'lowPrice'      => '0',
            'highPrice'     => number_format($plans['annual']['amount_pence']/100,2,'.',''),
            'offerCount'    => 4,
            'offers'        => [
                [
                    '@type'         => 'Offer',
...
<section class="hero" id="hero">
    <div class="container hero-content reveal">
        ...
        <p class="hero-note"><?php echo $aimee_market === 'uk' ? 'No credit or debit card required. Choose a GoCardless bank membership only if you actually like me.' : 'No card required for the preview. New US paid checkout is currently unavailable; there is no Stripe alternative.'; ?></p>
    </div>
</section>
...
<section class="architecture" style="background: var(--bg-alt);">
    <div class="container">
        ...
        <div class="arch-grid">
            ...
            <div class="arch-card reveal" style="transition-delay:.16s;"><h3>My Autonomous Pulse</h3><p>This is the closest software comparison to an autonomic rhythm. With your permission and inside your Safe Windows, I can remember a plan, follow up later or send the first message through the app, push or <?php echo $c['mobile_available'] ? esc_html($aimee_market === 'us' ? 'SMS through my UK +44 number' : 'UK SMS') : 'mobile messaging where available'; ?>.</p></div>
...
<section id="membership" class="pricing-section">
    <div class="container">
        <div class="section-header reveal">
            ...
            <p><?php echo $aimee_market === 'uk' ? "Look, your first 30 replies are entirely on me. Let's see if we actually click before you choose a GoCardless bank membership." : "Your first 30 replies are entirely on me. New paid checkout is GoCardless-only and is not currently available for US profiles; no Stripe or card alternative is offered."; ?></p>
        </div>
        ...
        <div class="preview-banner reveal">
            ...
            <div class="preview-pill"><?php echo esc_html($c['symbol']); ?>0 to begin</div>
        </div>

        <div class="pricing-grid">
            <article class="price-card reveal">
                <h3>Weekly</h3>
                <div class="price"><?php echo esc_html(aimee_global_money($plans['weekly']['amount_pence'],$aimee_market)); ?> <small>/ week</small></div>
            ...
            <article class="price-card recommended reveal" style="transition-delay:.08s;">
                ...
                <h3>Monthly</h3>
                <div class="price"><?php echo esc_html(aimee_global_money($plans['monthly']['amount_pence'],$aimee_market)); ?> <small>/ month</small></div>
            ...
            <article class="price-card reveal" style="transition-delay:.16s;">
                <h3>Annual</h3>
                <div class="price"><?php echo esc_html(aimee_global_money($plans['annual']['amount_pence'],$aimee_market)); ?> <small>/ year</small></div>
                <p class="price-sub">For when you already know you want me around.</p>
                <ul class="price-features">
                    <li>Everything in Monthly</li>
                    <li>Equivalent to around <?php echo esc_html(aimee_global_money(round($plans['annual']['amount_pence']/12),$aimee_market)); ?> per month</li>
        ...
        <p class="pricing-fineprint"><?php if ($aimee_market === 'uk'): ?>New memberships use GoCardless bank checkout and renew automatically until cancelled. Existing members can review their bank membership or cancel future renewals securely from their Aimee account. Access continues until the end of any paid period. My complimentary preview never asks for a card.<?php else: ?>The prices above are reference information only while new US paid checkout is unavailable. My complimentary preview remains available and never asks for a card. Existing legacy memberships can still be managed while they are closed out, but no new Stripe checkout is offered.<?php endif; ?></p>
    </div>
</section>
...
<section class="ecosystem">
    <div class="container reveal">
        ...
        <div class="eco-grid">
            ...
            <a href="<?php echo esc_url($pricing_url); ?>" class="eco-card"><div class="eco-icon">⚡</div><h3>Membership</h3><p><?php echo $aimee_market === 'uk' ? 'Start with 30 complimentary replies, then choose a GoCardless plan if you want to keep the connection going.' : 'Start with 30 complimentary replies. New US paid checkout is currently unavailable.'; ?></p></a>

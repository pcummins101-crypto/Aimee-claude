...
$canonical_url = home_url('/privacy/');
...
<?php wp_body_open(); ?>
<header class="topbar"><div class="wrap nav"><a class="brand" href="<?php echo esc_url(home_url('/home/')); ?>">Aimee</a><nav class="nav-right"><a href="#privacy-notice">Privacy</a><a href="#safeguarding">Safeguarding</a><a href="#rights-complaints">Your rights</a><a href="https://engramintelligence.com" target="_blank" rel="noopener">Engram Intelligence</a><a class="button" href="<?php echo esc_url(home_url('/chat/')); ?>">Open Aimee</a></nav></div></header>
...
<a href="#official-sources">Official sources</a></nav><div class="sidebar-note">For immediate danger, call 999 or 112. Aimee is not an emergency service and this page is not monitored continuously.</div></aside>
...
<p>Privacy, rights or complaints: <a href="mailto:<?php echo esc_attr($privacy_email); ?>"><?php echo esc_html($privacy_email); ?></a>. Post: 34–40 Witham, Witham, Hull, England, HU9 1BY. For immediate danger call 999 or 112. In the UK and Republic of Ireland, Samaritans can be reached on 116 123. Aimee is not monitored continuously and is not an emergency channel.</p><div class="callout warning"><strong>Emergency:</strong> If someone is in immediate danger, call 999 or 112. Aimee is not continuously monitored and is not an emergency channel.</div></div>
</details>
...
<div class="document-body"><h2>11. Your choices and rights</h2>

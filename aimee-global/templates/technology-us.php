                ...
                <div class="systems-grid">
                    <article class="system-card reveal">
                        ...
                        <ul>
                            ...
                            <li>In-app messaging, push and optional SMS through Aimee’s UK +44 number</li>
                        </ul>
                    ...
                    <article class="system-card reveal" style="transition-delay:.08s;">
                        ...
                        <p>I operate across a responsive web application, installable PWA, push notifications, private media and mobile messaging. For US users, SMS uses my UK +44 number and carrier international-message charges may apply.</p>
                        <ul>
                            <li>Live date, time, weather, news and searched facts</li>
                            <li>FireText integration through Aimee’s UK +44 number</li>
